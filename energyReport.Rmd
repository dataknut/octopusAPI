...
annualTotal
message("Projected annual elec cost @ 24p - including standing charge")
elec_kWh <- 0.24
annualCost <- (annualTotal*elec_kWh)+(365*0.2401)
annualCost
message("Projected mean monthly elec cost @ 24p - including standing charge")
annualCost/12
```
...
annualTotal <- mean(t$sumkWh)*365
annualTotal
message("Projected gas annual cost @ 7p - including standing charge")
gas_kWh <- 0.0719
annualCost <- (annualTotal*gas_kWh)+(365*.261)
annualCost
message("Projected mean gas monthly cost @ 7p - including standing charge")
annualCost/12
```
