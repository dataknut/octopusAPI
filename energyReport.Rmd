...
maxGRID <- max(ngeso_dt_orig$dv_start)
today <- lubridate::today()

if((lubridate::now() - maxGRID) > 0.5){
  # old data, reload
...
make_kwhComparisonPlot <- function(dt, # half hourly smart meter data
  ...
  session_HalfHourlyDT[, legend_lab := "SavingSession kWh"]
  ...
  wt[, kwh_diff := `SavingSession kWh` - `Comparison mean kWh`]
...
```{r fourthSavingSessionsCI, fig.cap="Third #SavingSessions - comparison of carbon intensity"}
