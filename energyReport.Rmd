...
The following two plots are both stacked so the height if the columns shows total daily cost.

```{r totalcostsPlot, fig.cap = "Total daily electricity & gas costs"}
...
```{r, fig.cap = "Total daily electricity & gas kWh"}
