...
annualTotal
message("Projected annual elec cost @ ", elec_kWh,"p - including standing charge")
annualCost_capped <- (annualTotal*elec_kWh)+(365*0.2401) # standing charge
annualCost_capped
message("Projected mean monthly elec cost @ ", elec_kWh,"p - including standing charge")
latestMonthlyElec <- annualCost_capped/12
latestMonthlyElec

message("That's an increase of ", round(100*(annualCost_capped/annualCost),2),  " %")
...
annualTotal <- mean(t$sumkWh)*365
annualTotal
message("Projected annual gas cost @ £", gas_kWh,"/kWh - including standing charge @ £", gas_sc, " £/day")
...
message("Projected annual gas cost @ £", gas_kWh,"/kWh - including standing charge @ £", gas_sc, " £/day")
annualCost_capped <- (annualTotal*gas_kWh)+(365*gas_sc) # standing charge
annualCost_capped
message("Projected mean monthly gas cost (£)")
...
message("That's an increase of ", round(100*(latestMonthlyGas/annualCost),2),  " %")
```
...
message("# Elec £:", round(latestMonthlyElec,2))

message("Annual: £", round(12*latestMonthlyElec,2))

message("# Gas £:", round(latestMonthlyGas,2))

message("Annual: £", round(12*latestMonthlyGas,2))

message("# Total")
message("Monthly total £:", round(latestMonthlyElec + latestMonthlyGas, 2))


message("Annual total £:", round(12 * (latestMonthlyElec + latestMonthlyGas),2))
```
