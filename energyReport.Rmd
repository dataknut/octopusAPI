...
Table \@ref(tab:recentTotalcosts) shows recent usage and costs using the EPG cap prices (see detail above).
...
daily_costs <- daily_gas[, .(dv_date, dow, gas_sum_kWh, gas_cost)][daily_elec[,.(dv_date, elec_sum_kWh, elec_cost)]]
