...
Figure \@ref(fig:firstSavingSessionsUsage) shows how we did in the first #SavingSessions **compared to the last n similar days of the week over the last 2 months**.
...
For fun - Figure \@ref(fig:fourthSavingSessionsCI) shows the mean carbon intensity in g CO2(e) per kWh for each half-hour.

```{r fourthSavingSessionsCI, fig.cap="Fourth #SavingSessions - comparison of carbon intensity"}
...
For fun - Figure \@ref(fig:fifthSavingSessionsCI) shows the mean carbon intensity in g CO2(e) per kWh for each half-hour.

```{r fifthSavingSessionsCI, fig.cap="Fifth #SavingSessions - comparison of carbon intensity"}
...
> 09:00 - 10:00 £2.50/kWh

Figure \@ref(fig:sixthSavingSessionsUsage) shows how we _did_would have done had we entered_ for this #SavingSession compared to the last n similar days of the week.
...
For fun - Figure \@ref(fig:sixthSavingSessionsCI) shows the mean carbon intensity in g CO2(e) per kWh for each half-hour.

```{r sixthSavingSessionsCI, fig.cap="Sixth #SavingSessions - comparison of carbon intensity"}
