...
```{r plotElecImportHalfHourly, fig.cap="Electricity import (current year)"}
...
Figure \@ref(fig:plotElecImportDaily) shows the mean daily kWh import with a smoothed curve.

> To do: mark weekends etc

```{r plotElecImportDaily, fig.cap="Electricity import (current year)"}
...
```{r plotGasImport, fig.cap="Gas consumption (current year)"}
...
```{r plotGasImportDaily, fig.cap="Electricity import (current year)"}
